...
const b = {
    top: (s) => chalk.bold.hex(BORDER_COLOR)(s),
    divider: (s) => chalk.bold.hex(BORDER_COLOR)(s),
    content: (s) => chalk.bold.hex(BORDER_COLOR)(s),
    footer: (s) => chalk.bold.hex(BORDER_COLOR)(s),
};
...
async function compareWithMain(branch) {
